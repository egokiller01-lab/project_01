...
const koHome: HomeContent = {
  ...
  sectionSummaries: {
    value:
      "약품 공급 전에 소재, 공정, 불량 증상, 관리 기록을 함께 보고 현장 안정화까지 연결합니다.",
    solutions:
      "Home에서는 주요 공정 축만 보여주고, 전체 8개 제품군은 제품·솔루션 페이지에서 확인합니다.",
    technology:
      "도금욕 분석부터 조건 조정과 재확인까지, 문제 원인을 단계별로 좁혀갑니다.",
    quality:
      "원료 확인부터 LOT 관리까지 이어지는 제조·검사 흐름으로 공급 신뢰를 관리합니다.",
    knowledge:
      "검증된 기술 블로그와 자료 요청 경로를 분리해 필요한 정보로 바로 이동할 수 있게 합니다.",
  },
  featuredProducts: [
    {
      slug: "pretreatment",
    ...
    },
    {
      ...
      title: "도금·무전해도금",
      summary:
        "전기도금과 무전해도금의 bath 관리, 적용 소재, 불량 원인을 함께 검토합니다.",
      href: "/ko/solutions/",
      materials: "금속 부품 · 전자 부품",
  ...
  supportFlow: [
    ...
    },
    {
      title: "조건 조정과 안정화",
      summary:
        "약품 보충, 욕관리, 신규 공정 적용 후 재확인 흐름으로 연결합니다.",
      checks: ["보충", "욕관리", "재확인"],
    },
  ],
